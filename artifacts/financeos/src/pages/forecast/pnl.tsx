...
export default function PnlForecastPage() {
  return (
    <ForecastLayout title="P&L Forecast" subtitle="Projected profit & loss — not yet implemented">
      <div
        data-testid="forecast-pnl-unavailable"
        className="flex items-start gap-3 rounded-lg border border-amber-100 bg-amber-50 px-4 py-3"
      >
        <AlertCircle className="w-4 h-4 text-amber-500 shrink-0 mt-0.5" />
        <p className="text-[12px] text-amber-900">
          <span className="font-semibold">P&amp;L forecast is not yet available.</span>{" "}
