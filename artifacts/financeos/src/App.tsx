...
import { AccountingPeriodProvider } from "@/lib/accounting-period-context";
...
import BankingAccountPage from "@/pages/accounting/banking-account";
...
function AccountingRoutes() {
  return (
    ...
    <Switch>
      ...
      <Route path="/accounting/banking/accounts/:accountId" component={BankingAccountPage} />
...
function CommissionRoutes() {
  return (
    ...
    <Switch>
      ...
      <Route path="/commissions/documents/:documentId" component={CommissionDocumentDetailPage} />
      <Route path="/commissions/documents" component={CommissionDocumentsPage} />
