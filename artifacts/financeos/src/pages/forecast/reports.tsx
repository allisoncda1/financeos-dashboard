...
export default function ForecastReportsPage() {
  return (
    <ForecastLayout title="Forecast Reports" subtitle="Exportable forecast reports — not yet implemented">
      <div
        data-testid="forecast-reports-unavailable"
        className="flex items-start gap-3 rounded-lg border border-amber-100 bg-amber-50 px-4 py-3"
      >
        <AlertCircle className="w-4 h-4 text-amber-500 shrink-0 mt-0.5" />
        <p className="text-[12px] text-amber-900">
          <span className="font-semibold">Forecast reports are not yet available.</span>{" "}
