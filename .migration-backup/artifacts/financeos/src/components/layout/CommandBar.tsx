...
import {
  ...
  DollarSign, Settings, X, ArrowRight,
} from "lucide-react";
...
const COMMANDS: Command[] = [
  ...
  { id: "financials",  label: "Consolidated Financials",  desc: "P&L · Balance Sheet · Cash Flow",     icon: DollarSign,      href: "/analyze/consolidated",  category: "Analyze" },
  { id: "cashflow",    label: "Cash Flow Analysis",       desc: "Portfolio cash trends",               icon: TrendingUp,      href: "/analyze/cashflow",      category: "Analyze" },
